...
import com.VirtualClassroom.dao.InsertStaffDao;
...
public class AdminStaffServlet extends HttpServlet {
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
		...
		// String name =request.getParameter("name");
		InsertStaffDao id = new InsertStaffDao();
		boolean insertion = id.insert(login_id, password, name, age, email, house_no, street, city, state, country);
		if (insertion == true) {
